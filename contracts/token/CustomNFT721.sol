...
contract CustomNFT721 is Ownable, SignerRole, IERC721, ERC721Base {
    event CreateERC721(address indexed creator, address signer, string name, string symbol);
    ...
    constructor(
        ...
        _addSigner(signer);
        emit CreateERC721(msg.sender, signer, name, symbol);
    }
